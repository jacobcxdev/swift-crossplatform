...
internal val logger: SkipLogger = SkipLogger(subsystem = "fuse.app", category = "FuseApp")

private typealias AppRootView = FuseAppRootView
private typealias AppDelegate = FuseAppDelegate
