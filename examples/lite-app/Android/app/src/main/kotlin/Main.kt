...
internal val logger: SkipLogger = SkipLogger(subsystem = "lite.app", category = "LiteApp")

private typealias AppRootView = LiteAppRootView
private typealias AppDelegate = LiteAppDelegate
